...
//   return (
//     <div>
//       <div className="sm:pt-[30vh] text-black">
//         <h2 className="font-[font2] text-[10vw] uppercase">Projects</h2>
//       </div>
//       <div className="sm:-mt-15 parent md:-mt-8">
//         {projectImages.map(function(elem,idx){
//           return <div key={idx} className="hero w-full sm:h-[500px] mb-5 flex gap-5 h-[300px]">
...
const Projects = () => {
  ...
  return (
    <div className="px-4 sm:px-8">
      {/* Title */}
      <div className="sm:pt-[30vh] pt-[15vh] text-black">
        <h2 className="font-[font2] text-[12vw] sm:text-[10vw] uppercase leading-none">
          Projects
        </h2>
      </div>

      {/* Projects List */}
      <div className="parent mt-6 sm:-mt-15 md:-mt-8 flex flex-col gap-6">
        {projectImages.map((elem, idx) => (
          <div
            key={idx}
            className="
              hero w-full 
              h-[220px] xs:h-[250px] sm:h-[400px] lg:h-[500px]
              flex flex-col sm:flex-row gap-3 sm:gap-5
